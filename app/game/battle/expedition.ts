...
export const PARTNERS: PartnerDefinition[] = [
  { id: "sword-sister", name: "沈清霜", title: "霜华一剑", tag: "剑", power: "screenDamage", description: "霜华剑意横扫全场，对所有妖物造成重创。", art: "/assets/characters/portrait-refresh/shen-qingshuang.png" },
